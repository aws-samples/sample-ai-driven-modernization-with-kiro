...
- [ ] **Validate after import** — object counts, `CHECKSUM TABLE` / aggregate checks across the gap,
      and a full application regression/CRUD round-trip (see SKILL.md Phase 7).
...
- **Default charset** changed `latin1` → **`utf8mb4`**, default collation `utf8mb4_0900_ai_ci`.
  ...
  (SKILL.md Phase 7 collation check).
...
> **Run the concrete post-upgrade validation checks in SKILL.md Phase 7 →
